...
#
# This file contains versioning information for Hetero-Trigger's configure process.
...
m4_define([HT_VERSION_m4],[0.0])dnl
m4_define([HT_RELEASE_DATE_m4],[unreleased development copy])dnl
...
m4_define([libht_so_version_m4],[0:0:0])dnl
